<?php
//Page is used to fetch chats from a module or course
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST["receiver_id"])){
        ...
        $sql ="SELECT message_id, sender_id, message, cmmessages.unix_timestamp, fname, lname, user_id from cmmessages INNER JOIN accounts ON cmmessages.sender_id = accounts.user_id WHERE group_id = :group_id ORDER BY unix_timestamp DESC LIMIT $totalmessages";
